...
#  This version of Profiler is ment to be used as an additional Cuckoo Sandbox reporting module
...
class profiler(Report):
    """Creates profiles report in MongoDB. as well as strores reports in profiles forder"""
...
#search for current malware's md5
        md5_list = []  
        md5_list.append(results["file"]["md5"])
...
# create profiles folder
        ...
        #actually only one md5 of the current malware under analysis
        for r in md5_list:
            results_dict = {}
...
# Only if there are new analysis results continue
            ...
            # generate txt report
            # the format of the txt template was based on cuckoo's version 0.3 txt template and was modified to present profiler's results
	        """
            ...
            # Create dropped files stacked bar chart
                    ...
                    ('All Execs '+str(counter_all), 'Varied '+str(counter_varied), 'Unique '+str(counter_unique)) )
